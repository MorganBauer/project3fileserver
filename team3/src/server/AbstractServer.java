...
public abstract class AbstractServer {
    ...
    protected static abstract class AbstractServerThread extends Thread{
         ...
         */
        protected AbstractClientMessage readInstream() throws IOException, JAXBException{
    ...
    protected static final class PrioritySocket implements Comparable<PrioritySocket>{
         ...
         */
        public static PrioritySocket wrapSocket(Socket client,AbstractClientMessage currentMsg){
         ...
         */
        public AbstractClientMessage getCurrentMsg(){ return currentMsg; }
        /**
